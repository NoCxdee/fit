  ...
  <svg viewBox="0 0 24 24" width="100%" height="100%">
    <defs>
      <linearGradient id="gitGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <stop offset="100%" stopColor="#D2391E" />
      </linearGradient>
    </defs>
    <path fill="url(#gitGrad)" d="M22.5 11.24L12.76 1.5a1.07 1.07 0 00-1.52 0L9 3.73l2.84 2.84a1.86 1.86 0 011.08-.29 1.89 1.89 0 011.89 1.89 1.85 1.85 0 01-.36 1.1l2.82 2.82c.38-.2.83-.33 1.3-.33A1.89 1.89 0 0120.47 13.7a1.89 1.89 0 01-1.89 1.89 1.89 1.89 0 01-1.89-1.89 1.86 1.86 0 01.38-1.12l-2.82-2.82c-.36.21-.79.35-1.25.35A1.89 1.89 0 0111 8.24c0-.44.15-.85.39-1.2L8.54 4.2L1.5 11.24a1.07 1.07 0 000 1.52l9.74 9.74a1.07 1.07 0 001.52 0l9.74-9.74a1.07 1.07 0 000-1.52z" />
  </svg>
);
