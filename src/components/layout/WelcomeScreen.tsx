...
function getRelativeTime(timestamp: number | undefined, lang: Lang): string {
  ...
  const t = {
    en: {
      now: 'just now',
      sec: (n: number) => `${n} second${n > 1 ? 's' : ''} ago`,
      min: (n: number) => `${n} minute${n > 1 ? 's' : ''} ago`,
    ...
    es: {
      now: 'ahora mismo',
      sec: (n: number) => `hace ${n} segundo${n > 1 ? 's' : ''}`,
      min: (n: number) => `hace ${n} minuto${n > 1 ? 's' : ''}`,
      hour: (n: number) => `hace ${n} hora${n > 1 ? 's' : ''}`,
      day: (n: number) => `hace ${n} día${n > 1 ? 's' : ''}`,
      many: 'hace mucho tiempo'
    },
    fr: {
      now: 'à l\'instant',
      sec: (n: number) => `il y a ${n} seconde${n > 1 ? 's' : ''}`,
      min: (n: number) => `il y a ${n} minute${n > 1 ? 's' : ''}`,
      hour: (n: number) => `il y a ${n} heure${n > 1 ? 's' : ''}`,
