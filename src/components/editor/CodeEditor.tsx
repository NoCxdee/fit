...
export function CodeEditor({ filePath, fileName, tabId }: CodeEditorProps) {
  ...
  return (
    <div className="editor-container" style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0, height: '100%', width: '100%' }}>
      <div ref={containerRef} style={{ flex: 1, overflow: 'auto', height: '100%', width: '100%' }} />
    </div>
  );
}
